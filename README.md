...
<li>for OpenID Connect support, the <i>pac4j-oidc</i> dependency is required</li>
</ul>
...
The current version **1.1.6-SNAPSHOT** is under development. It's available on the [Sonatype snapshots repository](https://oss.sonatype.org/content/repositories/snapshots/org/pac4j) as a Maven dependency:

The latest release of the **play-pac4j** project is the **1.1.5** version:
