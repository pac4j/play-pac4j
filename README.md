...
| 2.5          | 1.9           | [play-pac4j 2.5.x](https://github.com/pac4j/play-pac4j/tree/2.5.x) (Java & Scala)
...
- the `play-pac4j` library (<em>groupId</em>: **org.pac4j**, *version*: **2.6.0-SNAPSHOT**)
...
See the [release notes](https://github.com/pac4j/play-pac4j/wiki/Release-notes). Learn more by browsing the [play-pac4j Javadoc](http://www.javadoc.io/doc/org.pac4j/play-pac4j/2.6.0) and the [pac4j Javadoc](http://www.pac4j.org/apidocs/pac4j/1.9.4/index.html).
...
The version 2.6.0-SNAPSHOT is under development.
